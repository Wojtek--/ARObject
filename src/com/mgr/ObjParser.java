...
import com.mgr.BaseFileUtil;
import com.mgr.Group;
import com.mgr.Model;
import com.mgr.MtlParser;
import com.mgr.ParseException;
import com.mgr.SimpleTokenizer;
import com.mgr.Util;
					...
					for (int i = 0; i < 3; i++) {
						...
						if(textureID != -1) {
							...
							for (int j = 0; j < TEXTURE_COORD_DIMENSIONS; j++)
								curGroup.groupTextcoords.add(vec[j]);
						}
						try {
